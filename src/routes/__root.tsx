...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Media World" },
      { name: "theme-color", content: "#0D1612" },
      { property: "og:title", content: "MW Studio — Media World" },
      { property: "og:description", content: "Sistema interno de produção audiovisual — Media World." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "MW Studio — Media World" },
      { name: "twitter:description", content: "Sistema interno de produção audiovisual — Media World." },
    ],
    links: [
